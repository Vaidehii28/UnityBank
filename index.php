    ...
    <div class="container d-flex justify-content-between">
      ...
      <div class="logo">
        <!-- Uncomment below if you prefer to use an text logo -->
         <h1><a href="index.php">Unity BANK</a></h1> 
        <!--<a href="index.php"><img src="./assets/img/favicon.png" alt="Logo" class="img-fluid"><b>&nbsp;&nbsp;Unity BANK</b></a>-->
      </div>
  ...
  <section id="hero" class="clearfix">
    <div class="container" data-aos="fade-up">
      ...
      <div class="hero-info" data-aos="zoom-in" data-aos-delay="100">
        <h2>Welcome to the<br><span>Unity Bank</span><br>Services!</h2>
        <div>
  ...
  <main id="main">
    ...
    <section id="about">
      <div class="container" data-aos="fade-up">
        ...
        <header class="section-header">
          <h3>About Us</h3>
          <p>Unity is an Indian multinational, public sector banking and financial services statutory body, fostering the nation’s 2.6 trillion-dollar economy and serving the hopes of its vast population.</p>
        </header>
        ...
        <div class="row about-container">
          ...
          <div class="col-lg-6 content order-lg-1 order-2">
            <p>
              For Unity, the interests of the common man havealways remained at the core of its business.With a customer-centric approach, the Bankhas designed products and services to meet the expectations of the financial life cycle of its valued clientele. Keeping pace with the transforming landscape of the Indian economy, Unity has broadened its digital base in the recent years. 
            </p>
    ...
    <section id="services" class="section-bg">
      <div class="container" data-aos="fade-up">
        ...
        <header class="section-header">
          <h3>Notice</h3>
          <p>Here are some latest updates from Unity Bank. Read this notices carefully</p>
        </header>
        ...
        <div class="row justify-content-center">
          ...
          <div class="col-md-6 col-lg-5" data-aos="zoom-in" data-aos-delay="200">
            <div class="box">
              ...
              <p class="description">  Dear Customer, if you have donated for PM CARES through Unity Internet Banking, you can download the Receipt from PMCares portal of govt. using the reference number available with you. </p>
            </div>
          </div>
          ...
          <div class="col-md-6 col-lg-5" data-aos="zoom-in" data-aos-delay="100">
            <div class="box">
              ...
              <h4 class="title"><a href="">Unity BANKING</a></h4>
              <p class="description"> Have you tried our new simplified and intuitive business banking platform? Log in to Unitybank to avail business banking services</p>
            </div>
          </div>
          <div class="col-md-6 col-lg-5" data-aos="zoom-in" data-aos-delay="200">
            <div class="box">
        ...
        <div class="row row-eq-height justify-content-center">
          ...
          <div class="col-lg-4 mb-4">
            <div class="card" data-aos="zoom-in" data-aos-delay="200">
              ...
              <div class="card-body">
                <h5 class="card-title">Unity Bank Card</h5>
                <p class="card-text">20% discount of Flipart products.Pay using Unity Bank card.</p>
                <a href="#" class="readmore">Read more </a>
              </div>
            </div>
          </div>
              ...
              <div class="swiper-wrapper">
                ...
                <div class="swiper-slide">
                  <div class="testimonial-item">
                    ...
                    <h3>Avantika Kodape</h3>
                    <h4>Web Developer</h4>
                    <p>
                      I am very happy with the service which Unity bank provides. The coordinator Vaidehi Mahyavanshi was actively involved in the entire procedure. Thank you very much once again for all your efforts and help. You are doing great Job and keep up the good work.
                ...
                <div class="swiper-slide">
                  <div class="testimonial-item">
                    ...
                    <p>
                      It was a great experience. The process was very smooth and simple. Executive, both from Unity bank were very helpful, gave regular updates during the entire process. If looking for the best services then go for UNITY BANK without any second thought.
                    </p>
                  </div>
                </div><!-- End testimonial item -->
                ...
                <div class="swiper-slide">
                  <div class="testimonial-item">
                    ...
                    <h4>Pharmacist</h4>
                    <p>
                      Excellent coordination and cooperation by Unity Bank. Thanks to Vaidehi for the best work. They are good people and provide best service to the customers without any problem. Her proactive approach in regards with the communication with banker, timely feedback really was a tremendous great help for me. Her excellence in communication, coordination, timely feedback was always a great support and help.
                    </p>
                  </div>
                </div><!-- End testimonial item -->
                ...
                <div class="swiper-slide">
                  <div class="testimonial-item">
                    ...
                    <h4>Entrepreneur</h4>
                    <p>
                      Vaidehi did a good job and ensured compliance with the loan process and provided the right guidance for Balance Transfer of loan.
                    </p>
                  </div>
                </div><!-- End testimonial item -->
...
<!-- ======= Contact Section ======= -->
  ...
  <footer id="footer">
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-3 col-md-6 footer-contact">
            <h4>Contact Us</h4>
            <p>
              Near krishna signature mall, <br>
              Station Road<br>
              Umbergaon. 396165 <br>
              <strong>Phone:</strong> +919054578966<br>
              <strong>Email:</strong> vaidehi282002@gmail.com<br>
            </p>

            <div class="social-links">
              <a href="https://wwwfacebook.com/vaidehi.mahyavanshi.7" class="facebook"><i class="bi bi-facebook"></i></a>
              <a href="https://www.instagram.com/vaidehii__" class="instagram"><i class="bi bi-instagram"></i></a>
              <a href="https://www.linkedin.com/in/vaidehi-mahyavanshi-04b920204/" class="linkedin"><i class="bi bi-linkedin"></i></a>
            </div>
    ...
    <div class="container">
      <div class="copyright">
        &copy; 2023 Copyright <strong>Vaidehi Mahyavanshi</strong>. All Rights Reserved
      </div>
    </div>
  </footer><!-- End Footer -->
